...
/*
 * cleanup any leftover data structures from previous runs, just in case...
 */
set termout off
drop tablespace MSFT#SC_TS including contents and datafiles;
drop table MSFT#SC_GTT purge;
set termout on
prompt 
